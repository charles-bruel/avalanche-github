...
{
    public class WheelGeneratorStationT2 : MonoBehaviour, IWheelGenerator
    {
        ...
        public void Initialize()
        {
            ...
            int num = totalWheelCount;

            anglePerWheel = targetAngle / num;

            float distanceMax = 360f * wheelSpacing / anglePerWheel;
            radius = distanceMax / (Mathf.PI * 2f);

            GameObject[] newWheels = new GameObject[num];//A lot of this will never get used, but its legacy code from when the number of wheels was variable.
